---
name: github-commit
description: Sub-skill of `github`. Stage all changes, pull latest (resolving conflicts), commit with a conventional-commit message, and push. Honors the Output Contract inlined below.
---
