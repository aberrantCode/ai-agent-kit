...
$script:CategorySeed = [ordered]@{
    ...
    'brand-token-extraction-and-documentation' = 'Frontend'
    ...
    'css-variables-for-multi-theme-reskin' = 'Frontend'
    'csv-driven-llm-pipeline' = 'AI & LLM'
    'database-schema' = 'Databases & Storage'
    'deploy-idempotency-two-pass-gate' = 'Infrastructure & Ops'
    'deployment-driver-pin-rewrite-from-release-tag-source-of-truth' = 'Infrastructure & Ops'
    'design-critique-to-safe-refactor' = 'Code Quality'
    'diagnostics-probe-design' = 'Infrastructure & Ops'
    ...
    'firewall-alias-as-indirection' = 'Infrastructure & Ops'
    'fix-start' = 'Foundations & Workflow'
    'fleet-cp1252-mojibake-fix' = 'Infrastructure & Ops'
    'flutter' = 'Frontend'
    ...
    'gpu-workload-placement-and-arbitration' = 'Infrastructure & Ops'
    'grafana-dashboard-engineer' = 'Infrastructure & Ops'
    'grafana-dashboard-workflow' = 'Infrastructure & Ops'
    'graphify' = 'Tooling & DevOps'
    'guide-assistant' = 'Foundations & Workflow'
    'honcho' = 'AI & LLM'
    'honcho-deriver-queue-health-diagnostics' = 'Infrastructure & Ops'
    ...
    'lvm-thin-pool-diagnostics-recovery' = 'Infrastructure & Ops'
    'marko' = 'Languages & Runtimes'
    'medusa' = 'Commerce & Payments'
    'ms-teams-apps' = 'Third-Party Integrations'
    'multi-perspective-dns-diagnostic-ladder' = 'Infrastructure & Ops'
    ...
    'pwa-development' = 'Frontend'
    'python' = 'Languages & Runtimes'
    'react-best-practices' = 'Frontend'
    'react-native' = 'Frontend'
    'react-virtualization-with-jsdom-measurement' = 'Frontend'
    'react-web' = 'Frontend'
    'reactive-ui-state-with-delegated-event-routing' = 'Frontend'
    ...
    'self-contained-html-artifact-with-inline-assets' = 'Frontend'
    'self-paced-loop-iteration' = 'Foundations & Workflow'
    'session-management' = 'Foundations & Workflow'
    'shell-helper-migration' = 'Infrastructure & Ops'
    'shell-migration-skip-taxonomy' = 'Infrastructure & Ops'
    'shopify-apps' = 'Commerce & Payments'
    'side-effect-free-helper-library' = 'Infrastructure & Ops'
    ...
    'two-surface-observability-reconciliation' = 'Infrastructure & Ops'
    'typescript' = 'Languages & Runtimes'
    'ui-mobile' = 'Mobile (Native)'
    'ui-redesign-with-snapshot-regeneration' = 'Frontend'
...
# and is reused verbatim by generate-manifest.py's CategoryOrder list. Updated T5c
# (2026-07-14): 'DevOps & Tooling' -> 'Infrastructure & Ops'; 'Frontend Frameworks'
# and 'Frontend & UI' consolidated into a single 'Frontend' entry.
