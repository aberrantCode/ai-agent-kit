...
description: >
  ...
  comprehensive spec using the project's canonical template with iterative refinement. After saving, automatically generates a visual diagram of the
...
- If the user invoked `/add-feature` or is describing a feature idea conversationally, default to
  **Conversational Mode**.
- If the signal is ambiguous, prompt the user to pick:
...
4. **Create Initial Draft**:
   ...
   - Follow the project's architecture conventions (e.g., hexagonal architecture, canonical
     models, API standards — as documented in AGENTS.md and existing feature docs)
...
**First Action in this mode**: Ask the user 3-4 clarifying questions to understand:
